 ...
 * 
 * These tutorials help users navigate the basic features of Finance Footprint.
 * Add, edit, or remove tutorials from this file to update the Getting Started section.
 */
