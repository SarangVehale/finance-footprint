...
/**
 * TutorialContentRenderer - Renders specific tutorial content based on id
 * 
 * @param tutorialId - The id of the tutorial to render
 */
const TutorialContentRenderer: React.FC<{ tutorialId: string }> = ({ tutorialId }) => {
  switch (tutorialId) {
    case "account-setup":
